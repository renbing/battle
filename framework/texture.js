...
TextureManager.prototype = {
    load: function(libNames, callback) {
        libNames.forEach(function(libName){
            resourceManager.add('texture', libName + '.png');
            resourceManager.add('texture', libName + '.json');
        });
    ...
    createMovieClip: function(libName, linkName, name){
        ...
        var mcTexture = resourceManager.get('texture', libName + '.png');
        var mcConf = resourceManager.get('texture', libName + '.json');
